...
class ClipsBaseContainer extends PopupMenu.PopupBaseMenuItem {
    _init(type, filename, filepath, hasThumbnail, params) {
        ...
        // this._btnFileClip = this._generateActionIcon('file', 'file-symbolic.svg', 'clips-icons-actions', false);
    ...
    // _generateActionIcon (actionName, iconname, style_name, is_visible, has_hover_event) {
